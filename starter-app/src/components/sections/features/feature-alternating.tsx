...
export function FeatureAlternating({ features }: FeatureAlternatingProps) {
  return (
    <section className="py-20 px-4">
      <div className="w-[95%] md:w-[90%] lg:w-[80%] mx-auto space-y-32">
          ...
          return (
            <div key={index} className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className={`space-y-6 ${contentOrder}`}>
                <h2 className="text-3xl md:text-4xl font-heading">{feature.title}</h2>
                ...
                {feature.cta && (
                  <div className="pt-4">
                    <MagneticButton variant="primary" onClick={feature.cta.onClick}>
                      {feature.cta.text}
