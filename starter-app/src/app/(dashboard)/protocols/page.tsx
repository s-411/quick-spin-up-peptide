          ...
          <div className="mb-6">
            <ProtocolForm
              ...
              initialData={{
                ...
                customSchedule: editingProtocol.customSchedule as string[] | undefined,
                timeOfDay: editingProtocol.timeOfDay,
                preferredSites: editingProtocol.siteRotation,
                rotateSites: !!editingProtocol.siteRotation?.length,
